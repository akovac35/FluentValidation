...
namespace FluentValidation.Resources {
	...
	internal class SlovenianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			nameof(ScalePrecisionValidator) => "'{PropertyName}' ne sme imeti več kakor {ExpectedPrecision} števk, od tega največ {ExpectedScale} decimalk. Vnesli ste {Digits} števk in {ActualScale} decimalk.",
			...
			"Length_Simple" => "'{PropertyName}' mora imeti dolžino med {MinLength} in {MaxLength} znakov. ",
